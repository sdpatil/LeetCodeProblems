...
public class LRUCache {
    ...
    public void setHead(DLLListNode n) {
        DLLListNode nPrevNode = n.prev;
        DLLListNode nNextNode = n.next;

        nPrevNode.next = nNextNode;
        nNextNode.prev = nPrevNode;
    ...
    public void remove(DLLListNode n) {
        DLLListNode prevN = n.prev;
        DLLListNode nextN = n.next;
        prevN.next = nextN;
        nextN.prev = prevN;
    }
